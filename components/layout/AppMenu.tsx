        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        { label: 'QR Books', icon: 'pi pi-fw pi-book', to: '/qr/books' },
                        { label: 'QR Contents', icon: 'pi pi-fw pi-list', to: '/qr/contents' },
                        { label: 'QR Playlist', icon: 'pi pi-fw pi-play', to: '/qr/playlist' },
                        { label: 'QR Series', icon: 'pi pi-fw pi-clone', to: '/qr/series' },
                        { label: 'QR Groups', icon: 'pi pi-fw pi-tags', to: '/qr/groups' }
                    ]
                },
                {
                    label: 'Store',
                ...
                },
                {
                    ...
                    items: [
                        { label: 'Banner Image', icon: 'pi pi-fw pi-list', to: '/pages/notfound' }
                    ]
                },
                {
                    label: 'Donation',
                    ...
                    items: [
                        { label: 'Donation', icon: 'pi pi-fw pi-gift', to: '/pages/notfound' }
                    ]
                }
            ]
        },
