...
export default function ArticleView() {
    ...
    if (notFound || !article) {
        return (
            <div className="card flex flex-column align-items-center justify-content-center py-8 gap-3">
                ...
                <p className="text-500 m-0">Slug: <code>{slug}</code></p>
                <Button
    ...
    return (
        <div className="card">
            ...
            {/* ── Slug ── */}
            <small className="text-500 block mb-4">
                ...
                <div className="col-12 md:col-3">
                    <div className="flex flex-column gap-1">
                        ...
                        <span className="font-medium">
                            ...
                            {formatDate((article.article_published_at as string) || (article.created_at as string))}
                        </span>
                    </div>
                </div>
